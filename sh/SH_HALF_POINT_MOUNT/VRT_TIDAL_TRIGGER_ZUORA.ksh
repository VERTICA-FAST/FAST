...
if ((2<=10#$START_HOUR && 10#$START_HOUR<4))
then
    export cycle_no=1
elif ((4<=10#$START_HOUR && 10#$START_HOUR<6))
then
    export cycle_no=2
elif ((6<=10#$START_HOUR && 10#$START_HOUR<8))
then
    export cycle_no=3
elif ((8<=10#$START_HOUR && 10#$START_HOUR<10))
then
    export cycle_no=4
elif ((10<=10#$START_HOUR && 10#$START_HOUR<12))
then
    export cycle_no=5
elif ((12<=10#$START_HOUR && 10#$START_HOUR<14))
then
    export cycle_no=6
elif ((14<=10#$START_HOUR && 10#$START_HOUR<16))
then
    export cycle_no=7
elif ((16<=10#$START_HOUR && 10#$START_HOUR<18))
then
    export cycle_no=8
elif ((18<=10#$START_HOUR && 10#$START_HOUR<20))
then
    export cycle_no=9
elif ((20<=10#$START_HOUR && 10#$START_HOUR<22))
then
    export cycle_no=10
elif ((22<=10#$START_HOUR))
then
        export cycle_no=11
else
        export cycle_no=0
...
export TOUCH_FILE_PATH1=$MULETOUCHPATH/muleTouchFiles/$SUB_AREA1
...
export TOUCH_ERRORFILE_PATH1=$MULETOUCHPATH/muleErrorTouchFiles/$SUB_AREA1
