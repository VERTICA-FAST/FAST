...
### "Calling HRDD Script to call VSQL for loading stage to base of SmSh_Planning_Data table"

 echo "HRDD shell script execution started" >> $LOGDIR"/"$SUB_AREA"_Script_Log_"$DAY.log

 ksh /opt/FAST/sh/VRT_TIDAL_TRIGGER_HRDD.ksh 
