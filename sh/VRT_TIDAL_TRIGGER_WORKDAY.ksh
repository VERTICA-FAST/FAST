...
###################################### DESCRIPTION #########################################
#	This script checks load order of WORKDAY tables from a text file WORKDAY_LOAD_ORDER.txt
...
export rerun_flag=0
export OPT_SH_PATH=/opt/FAST/sh
...
### "Calling Executive Report Script to refresh the TRILEAD data 03/04/17"

 ksh $SH_PATH/ISS_Tidal_Trigger_SWAIR_DAILY_EXECUTIVE_REP.ksh>/home/omtsmgr/EXECUTIVE_REPORT/LOG/TriLead_Log.log


### "Calling SMARTSHEET Script to call VSQL for loading stage to base of SmSh_Planning_Data table"

 echo "SMARTSHEET shell script execution started" >> $LOGDIR"/"$SUB_AREA"_Script_Log_"$DAY.log

 ksh $OPT_SH_PATH/VRT_TIDAL_TRIGGER_SMARTSHEET.ksh 
