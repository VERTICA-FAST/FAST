...
,SWT_Related_Subscription__c
,SWT_Subscription_ELA_Agreement_Number__c
,SWT_Is_Large_Quote__c
,SWT_ELA_Original_Balance_New__c
,SWT_Migration_Required__c
...
SELECT DROP_PARTITIONS('swt_rpt_stg.AT_Apttus_Proposal__Proposal__c_Hist', TIMESTAMPADD(day,-7,getdate())::date);
