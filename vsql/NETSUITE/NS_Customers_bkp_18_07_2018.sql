...
DELETE /*+DIRECT*/ FROM swt_rpt_base.NS_Customers where Is_Deleted <> 'true' and customer_id not in ( select distinct customer_id from swt_rpt_stg.NS_Customers_Id);
...
DELETE /*+DIRECT*/ FROM swt_rpt_base.NS_Customers where Is_Deleted ='true' and customer_id in ( select distinct customer_id from swt_rpt_stg.NS_Customers_Id);
