...
DELETE /*+DIRECT*/ FROM swt_rpt_base.NS_Entity where Is_Deleted <> 'true' and entity_id not in ( select distinct entity_id from swt_rpt_stg.NS_Entity_Id);
...
DELETE /*+DIRECT*/ FROM swt_rpt_base.NS_Entity where Is_Deleted ='true' and entity_id in ( select distinct entity_id from swt_rpt_stg.NS_Entity_Id);
