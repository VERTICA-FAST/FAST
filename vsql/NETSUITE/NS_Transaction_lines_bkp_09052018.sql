/****
****Script Name   : NS_Transaction_lines.sql
****Description   : Incremental data load for NS_Transaction_lines
****/
...
( 
SELECT DISTINCT * FROM swt_rpt_stg.NS_Transaction_lines)
...
WHERE NOT EXISTS
(SELECT 1 FROM "swt_rpt_base".NS_Transaction_lines BASE
WHERE NS_Transaction_lines_stg_Tmp.transaction_id = BASE.transaction_id AND NS_Transaction_lines_stg_Tmp.transaction_line_id = BASE.transaction_line_id );
