...
,SWT_Cross_stack_campaign__c
,IC_Campaign_Name__c
,SWT_Heirarchy_levelformula__c
,Legacy_Campaign_Name__c
,SWT_Partners__c
,LD_DT
,SWT_INS_DT
,d_source
...
SELECT DROP_PARTITION('swt_rpt_stg.SF_Campaign_Hist', TIMESTAMPADD(day,-7,getdate())::date);
